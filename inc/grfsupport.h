...
GRFEXPORT GrfError *GRF_SetError(GrfError *err, GrfErrorType errtype, uint32_t line, const char *file, const char *func,
                                 void *extra);
...
#define GRF_SETERR_ADD(a, b, e, f) \
  GRF_SetError(a, b, __LINE__, __FILE__, #e, (uintptr_t *)f) /* NOTE: ? => uintptr_t* conversion */
